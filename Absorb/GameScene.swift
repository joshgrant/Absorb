...
//    let ball = Ball(radius: 120, position: CGPoint(x: 200, y: 400))
//    let otherBall = Ball(radius: 150, position: CGPoint(x: 100, y: 300))
...
//        addChild(otherBall)
    ...
    private func moveCameraToPlayer()
    {
        ...
        {
            camera.run(.move(to: player.position, duration: 0.8))
        }
    }
